...
class ChatGLM():
    def __init__(self, quantize_level, gpu_id) -> None:
        ...
        # self.model = AutoModel.from_pretrained("THUDM/chatglm-6b", trust_remote_code=True).quantize(8).half().cuda()
        self.model.eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--quantize', '-q', help='level of quantize, option：16, 8 or 4', default=8)
    parser.add_argument('--host', '-H', help='host to listen', default='0.0.0.0')
    parser.add_argument('--port', '-P', help='port of this service', default=1212)
